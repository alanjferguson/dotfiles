...
complete -c rustup -n "__fish_rustup_needs_command" -s v -l verbose -d 'Enable verbose output'
complete -c rustup -n "__fish_rustup_needs_command" -s q -l quiet -d 'Disable progress output'
...
complete -c rustup -n "__fish_rustup_needs_command" -a "install" -d 'Update Rust toolchains'
complete -c rustup -n "__fish_rustup_needs_command" -a "uninstall" -d 'Uninstall Rust toolchains'
...
complete -c rustup -n "__fish_rustup_using_subcommand install" -l profile -r -f -a "{minimal\t'',default\t'',complete\t''}"
complete -c rustup -n "__fish_rustup_using_subcommand install" -l no-self-update -d 'Don\'t perform self-update when running the `rustup install` command'
...
complete -c rustup -n "__fish_rustup_using_subcommand toolchain; and not __fish_seen_subcommand_from list install uninstall link help" -f -a "install" -d 'Install or update a given toolchain'
complete -c rustup -n "__fish_rustup_using_subcommand toolchain; and not __fish_seen_subcommand_from list install uninstall link help" -f -a "uninstall" -d 'Uninstall a toolchain'
...
complete -c rustup -n "__fish_rustup_using_subcommand toolchain; and __fish_seen_subcommand_from install" -l profile -r -f -a "{minimal\t'',default\t'',complete\t''}"
complete -c rustup -n "__fish_rustup_using_subcommand toolchain; and __fish_seen_subcommand_from install" -s c -l component -d 'Add specific components on installation' -r
complete -c rustup -n "__fish_rustup_using_subcommand toolchain; and __fish_seen_subcommand_from install" -s t -l target -d 'Add specific targets on installation' -r
...
complete -c rustup -n "__fish_rustup_using_subcommand toolchain; and __fish_seen_subcommand_from help" -f -a "install" -d 'Install or update a given toolchain'
complete -c rustup -n "__fish_rustup_using_subcommand toolchain; and __fish_seen_subcommand_from help" -f -a "uninstall" -d 'Uninstall a toolchain'
...
complete -c rustup -n "__fish_rustup_using_subcommand override; and __fish_seen_subcommand_from set" -l path -d 'Path to the directory' -r
complete -c rustup -n "__fish_rustup_using_subcommand override; and __fish_seen_subcommand_from set" -s h -l help -d 'Print help'
complete -c rustup -n "__fish_rustup_using_subcommand override; and __fish_seen_subcommand_from unset" -l path -d 'Path to the directory' -r
...
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "dump-testament" -d 'Dump information about the build'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "show" -d 'Show the active and installed toolchains or profiles'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "install" -d 'Update Rust toolchains'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "uninstall" -d 'Uninstall Rust toolchains'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "update" -d 'Update Rust toolchains and rustup'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "check" -d 'Check for updates to Rust toolchains and rustup'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "default" -d 'Set the default toolchain'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "toolchain" -d 'Modify or query the installed toolchains'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "target" -d 'Modify a toolchain\'s supported targets'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "component" -d 'Modify a toolchain\'s installed components'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "override" -d 'Modify toolchain overrides for directories'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "run" -d 'Run a command with an environment configured for a given toolchain'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "which" -d 'Display which binary will be run for a given command'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "doc" -d 'Open the documentation for the current toolchain'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "man" -d 'View the man page for a given command'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "self" -d 'Modify the rustup installation'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "set" -d 'Alter rustup settings'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "completions" -d 'Generate tab-completion scripts for your shell'
complete -c rustup -n "__fish_rustup_using_subcommand help; and not __fish_seen_subcommand_from dump-testament show install uninstall update check default toolchain target component override run which doc man self set completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c rustup -n "__fish_rustup_using_subcommand help; and __fish_seen_subcommand_from toolchain" -f -a "install" -d 'Install or update a given toolchain'
complete -c rustup -n "__fish_rustup_using_subcommand help; and __fish_seen_subcommand_from toolchain" -f -a "uninstall" -d 'Uninstall a toolchain'
